...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <asp:GridView CssClass="table" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="codigo" DataSourceID="SqlDisciplinas" AllowSorting="True" AllowPaging="True">
                <Columns>

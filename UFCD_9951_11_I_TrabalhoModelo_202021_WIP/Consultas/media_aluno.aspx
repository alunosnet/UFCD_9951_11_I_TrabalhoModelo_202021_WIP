<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="media_aluno.aspx.cs" Inherits="UFCD_9951_11_I_TrabalhoModelo_202021_WIP.Consultas.media_aluno" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <!--Listar a média das notas por aluno-->
            ...
            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT alunos.nome, AVG(notas.nota) AS [Média] FROM alunos INNER JOIN notas ON alunos.nprocesso = notas.nprocesso GROUP BY alunos.nprocesso, alunos.nome"></asp:SqlDataSource>
        </div>
    </form>
